...
def download_file(fname, target_dir="data/", force=False):
...
def download_and_parse_mnist_file(fname, target_dir="data/", force=False):
    ...
    with fopen(target_dir+fname, 'rb') as fd:
        return parse_idx(fd)
